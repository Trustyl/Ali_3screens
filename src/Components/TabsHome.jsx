...
function TabsHome() {
    ...
    return (
        <View style={{
            ...
            <TouchableOpacity>
                <Feather name="home" size={32} color="tomato" style={{ marginTop: 10, marginLeft: 15, flexDirection: "column" }} >

                </Feather>
                <Text style={{ fontSize: 11, marginLeft: 18, color: "tomato", marginTop: 2 }}>HOME</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('Worries')}>
                <Ionicons name="document-text-outline" size={32} color="#0092e7" style={{ marginTop: 10, marginLeft: 30 }} />
                <Text style={{ fontSize: 11, marginLeft: 25, color: "#0092e7" }}>WORRIES</Text>
            </TouchableOpacity>
